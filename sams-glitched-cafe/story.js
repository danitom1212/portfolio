...
export const STORY = {
  ...
  scenes: {
    ...
    return_scene: {
      ...
      dialogue: [
        { speaker: 'sam', emotion: 'shock', vfx: 'glitch', text: 'אתה… שוב פה? זה לא—זה לא אמור לקרות. אף אחד לא חוזר.' },
        { text: 'הקירות מרצדים בין טפט פרחוני לרשת קווים ירוקה, כמו מסך שמנסה לזכור מה הוא היה.' },
