...
export const STORY = {
  ...
  scenes: {
    ...
    enter_cafe: {
      ...
      dialogue: [
        { text: 'הפעמון מצלצל. הבחור מאחורי הדלפק מרים מבט — שיער סגול פרוע, חולצה עם כתמי קפה ישנים, וחיוך שנראה מזיק מדי בשביל שעה כזאת בלילה.', sfx: 'bell' },
    ...
    return_scene: {
      ...
      dialogue: [
        ...
        { text: 'הפעמון מצלצל. נועה נכנסת, מוקדם משהרגילה, ועיניה נעצרות בשניהם עומדים כל כך קרוב.', sfx: 'bell' },
      ],
    ...
    twist_reveal: {
      ...
      dialogue: [
        ...
        { speaker: 'noa', emotion: 'sad', text: 'שרפה. לפני שנה. כולם חושבים שאני זו שהשאירה את הכיריים דולקים.' },
        { speaker: 'sam', emotion: 'shock', text: 'נועה, בבקשה...' },
        { speaker: 'noa', vfx: 'shake', text: 'לא. הפעם היא תשמע את זה ממני. זה לא הייתי אני, סאם. זה היית אתה. התיקון החשמלי הזול שדחית כי לא היה כסף, ואז נתת לכולם — לי, לשכונה, לעצמך — לחשוב שזו הייתה קריסה שלי.' },
        { speaker: 'sam', emotion: 'sad', text: 'הייתי מאבד את המקום, את הביטוח, את הכל. פחדתי. ותמיד קל יותר לתת למישהי שכבר נשברה פעם להישבר עוד קצת.' },
        { speaker: 'yasmin', emotion: 'shock', text: 'שיקרת לי על אשתך. ונתת לה לשאת שרפה שאתה גרמת לה.' },
    ...
    choice_3: {
      ...
      choices: [
        { text: '"נשוי, ומשקר, ותולה את זה באישה שכבר נפגעה?! איך יכולת?"', effects: { rage: 5, affection: -1 }, next: 'end_confront' },
        ...
        { text: '"תוכיח את זה. פומבית — מול המבטח, מול השכונה, מול נועה קודם כול."', effects: { truth: 10, affection: 2 }, next: 'end_truth' },
    ...
    ending_together: {
      ...
      dialogue: [
        ...
        { speaker: 'sam', emotion: 'smile', text: 'זה רשמי. חצי מהמקום שייך לנועה, בלי שום קשר לחיים שלנו. הודעתי גם למבטח את האמת על השרפה — מאוחר, אבל אמיתי.' },
        { speaker: 'yasmin', emotion: 'smile', text: 'לא נעים לי מהאישה שנשאה אשמה שלא הייתה שלה שנה שלמה.' },
        { speaker: 'sam', text: 'גם לי לא. זה לא מתקן הכל. אבל זו התחלה — ואני מציע לך את הכיסא הזה, כל ערב, לתמיד.' },
    ...
    ending_truth: {
      ...
      dialogue: [
        ...
        { speaker: 'sam', emotion: 'sad', text: 'שלחתי הצהרה מתוקנת למבטח. וסיפור מלא לוועד השכונה. נועה, הראשונה שראתה את זה הייתה את.' },
        ...
        { speaker: 'yasmin', emotion: 'neutral', text: 'אני עדיין לא יודעת אם יש לנו סיפור אהבה, סאם. אבל עכשיו יש לנו לפחות סיפור אמיתי להתחיל ממנו.' },
    ...
    ending_heartbreak: {
      ...
      dialogue: [
        ...
        { speaker: 'yasmin', emotion: 'sad', text: 'הוא היה צריך רק לספר לי — על האישה, ועל השרפה. לא הייתי בורחת מהאמת. ברחתי מהשקר.' },
